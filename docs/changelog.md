...
Version history and changes for Postal.

---

## [Documentation Update] (2026-02-12)

### Documentation

* Reorganized all documentation files
* Moved root MD files to `docs/` directory (except README.md, License.md, Agents.md)
* Translated all German content to English
* Updated file references throughout documentation
* Standardized docker-compose file references (production: `docker-compose.yml`, development: `docker-compose.dev.yml`)
...
| DOCKER_COMPOSE_GUIDE.md | docs/docker-compose.md |
| CONTRIBUTING.md | docs/contributing.md |
| API_INVENTORY.md | docs/api-inventory.md |
| CHANGELOG.md | docs/changelog.md |

---

## [Modernization](https://github.com/relationsoftware/postal) (2026-01-24)

### Repository Structure

* Consolidated all documentation under `docs/` (renamed `doc/` → `docs/`)
* Moved `QUICKSTART.md` and `INSTALL-CHECKLIST.md` into `docs/`
* Updated `README.md` links to point to `docs/`

### Licensing

* Renamed `MIT-LICENCE` → `License.md` (content unchanged)

### CI/CD

* Updated GitHub Actions CI to run tests using `docker-compose.yml` and the `runner` service
* Enabled `POSTAL_IMAGE` override in compose for CI image testing

### Deployment

* Production `docker-compose.yml` supports overriding Postal image via `POSTAL_IMAGE`
